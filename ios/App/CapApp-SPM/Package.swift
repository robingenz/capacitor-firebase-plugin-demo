...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorFirebaseAnalytics", path: "symlinks/CapacitorFirebaseAnalytics"),
        ...
        .package(name: "CapacitorFirebaseFirestore", path: "symlinks/CapacitorFirebaseFirestore"),
        .package(name: "CapacitorFirebaseFunctions", path: "symlinks/CapacitorFirebaseFunctions"),
        ...
        .package(name: "CapacitorFirebaseStorage", path: "symlinks/CapacitorFirebaseStorage"),
